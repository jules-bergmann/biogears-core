...
//LEFT ANTERIOR
DEFINE_STATIC_STRING(LeftAnteriorVascularTerritory);
DEFINE_STATIC_STRING(LeftAnteriorArteries);
DEFINE_STATIC_STRING(LeftAnteriorCapillaries);
DEFINE_STATIC_STRING(LeftAnteriorVeins);
//LEFT MEDIAL
DEFINE_STATIC_STRING(LeftMedialVascularTerritory);
DEFINE_STATIC_STRING(LeftMedialArteries);
DEFINE_STATIC_STRING(LeftMedialCapillaries);
DEFINE_STATIC_STRING(LeftMedialVeins);
//RIGHT COROTID
DEFINE_STATIC_STRING(RightCorotid);
//RIGHT ANTERIOR
DEFINE_STATIC_STRING(RightAnteriorVascularTerritory);
DEFINE_STATIC_STRING(RightAnteriorArteries);
DEFINE_STATIC_STRING(RightAnteriorCapillaries);
DEFINE_STATIC_STRING(RightAnteriorVeins);
//RIGHT MEDIAL
DEFINE_STATIC_STRING(RightMedialVascularTerritory);
DEFINE_STATIC_STRING(RightMedialArteries);
DEFINE_STATIC_STRING(RightMedialCapillaries);
DEFINE_STATIC_STRING(RightMedialVeins);
//LEFT BASILAR
DEFINE_STATIC_STRING(LeftBasilar);
//LEFT POSTERIOR
DEFINE_STATIC_STRING(LeftPosteriorVascularTerritory);
DEFINE_STATIC_STRING(LeftPosteriorArteries);
DEFINE_STATIC_STRING(LeftPosteriorCapillaries);
DEFINE_STATIC_STRING(LeftPosteriorVeins);
//RIGHT BASILAR
DEFINE_STATIC_STRING(RightBasilar);
//RIGHT POSTERIOR
DEFINE_STATIC_STRING(RightPosteriorVascularTerritory);
DEFINE_STATIC_STRING(RightPosteriorArteries);
DEFINE_STATIC_STRING(RightPosteriorCapillaries);
DEFINE_STATIC_STRING(RightPosteriorVeins);
//HEMISPHERES
...
{
  static std::vector<std::string> _values = {
    Aorta, Heart, Myocardium, LeftHeart, LeftAtrium, LeftVentricle, RightHeart, RightAtrium, RightVentricle, 
    Pericardium, VenaCava, PulmonaryArteries, PulmonaryCapillaries, PulmonaryVeins, Lungs, LeftLung, LeftPulmonaryArteries, 
    LeftPulmonaryCapillaries, LeftPulmonaryVeins, RightLung, RightPulmonaryArteries, RightPulmonaryCapillaries, RightPulmonaryVeins, 
    Kidneys, LeftKidney, LeftRenalArtery, LeftNephron, LeftAfferentArteriole, LeftGlomerularCapillaries, LeftEfferentArteriole,
    LeftPeritubularCapillaries, LeftBowmansCapsules, LeftTubules, LeftRenalVein, RightKidney, RightRenalArtery, RightNephron, 
    RightAfferentArteriole, RightGlomerularCapillaries, RightEfferentArteriole, RightPeritubularCapillaries, RightBowmansCapsules, 
    RightTubules, RightRenalVein, Bone, Brain, Fat, Gut, Splanchnic, SmallIntestine, LargeIntestine, Liver, Spleen, Skin, Muscle, 
    LeftArm, LeftLeg, RightArm, RightLeg,
    //cerebral advanced
   LeftCorotid, LeftAnteriorVascularTerritory, LeftAnteriorArteries, LeftAnteriorCapillaries, LeftAnteriorVeins, LeftMedialVascularTerritory,
   LeftMedialArteries, LeftMedialCapillaries, LeftMedialVeins, RightCorotid, RightAnteriorVascularTerritory, RightAnteriorArteries, RightAnteriorCapillaries,
   RightAnteriorVeins, RightMedialVascularTerritory, RightAnteriorArteries, RightAnteriorCapillaries, RightAnteriorVeins, LeftBasilar, LeftPosteriorVascularTerritory,
   LeftPosteriorArteries, LeftPosteriorCapillaries, RightPosteriorVeins, RightBasilar, RightPosteriorVascularTerritory, RightPosteriorArteries, RightPosteriorCapillaries,
   RightPosteriorVeins, LeftHemisphere, RightHemisphere
...
//Advanced Cerebral
//LEFT COROTID
DEFINE_STATIC_STRING(AortaToLeftCorotid);
//LEFT ANTERIOR
DEFINE_STATIC_STRING(LeftCorotidToLeftAnteriorArteries);
DEFINE_STATIC_STRING(LeftAnteriorArteriesToCapillaries);
DEFINE_STATIC_STRING(LeftAnteriorCapillariesToVeins);
DEFINE_STATIC_STRING(LeftAnteriorVeinsToNeckVeins);
//LEFT MEDIAL
DEFINE_STATIC_STRING(LeftCorotidToLeftMedialArteries);
DEFINE_STATIC_STRING(LeftMedialArteriesToCapillaries);
DEFINE_STATIC_STRING(LeftMedialCapillariesToVeins);
DEFINE_STATIC_STRING(LeftMedialVeinsToNeckVeins);
//RIGHT COROTID
DEFINE_STATIC_STRING(AortaToRightCorotid);
//RIGHT ANTERIOR
DEFINE_STATIC_STRING(RightCorotidToRightAnteriorArteries);
DEFINE_STATIC_STRING(RightAnteriorArteriesToCapillaries);
DEFINE_STATIC_STRING(RightAnteriorCapillariesToVeins);
DEFINE_STATIC_STRING(RightAnteriorVeinsToNeckVeins);
//RIGHT MEDIAL
DEFINE_STATIC_STRING(RightCorotidToRightMedialArteries);
DEFINE_STATIC_STRING(RightMedialArteriesToCapillaries);
DEFINE_STATIC_STRING(RightMedialCapillariesToVeins);
DEFINE_STATIC_STRING(RightMedialVeinsToNeckVeins);
//LEFT BASILAR
DEFINE_STATIC_STRING(AortaToLeftBasilar);
DEFINE_STATIC_STRING(LeftBasilarToLeftCorotid);
//LEFT POSTERIOR
DEFINE_STATIC_STRING(LeftBasilarToLeftPosteriorArteries);
DEFINE_STATIC_STRING(LeftPosteriorArteriesToCapillaries);
DEFINE_STATIC_STRING(LeftPosteriorCapillariesToVeins);
DEFINE_STATIC_STRING(LeftPosteriorVeinsToNeckVeins);
//RIGHT BASILAR
DEFINE_STATIC_STRING(AortaToRightBasilar);
DEFINE_STATIC_STRING(RightBasilarToRightCorotid);
//RIGHT POSTERIOR
DEFINE_STATIC_STRING(RightBasilarToRightPosteriorArteries);
