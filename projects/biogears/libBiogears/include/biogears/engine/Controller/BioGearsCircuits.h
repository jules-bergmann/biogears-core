...
// Advanced Cerebral
DEFINE_STATIC_STRING(Aorta1ToLeftCorotid);
DEFINE_STATIC_STRING(Aorta1ToRightCorotid);
DEFINE_STATIC_STRING(Aorta1ToLeftBasilar);
DEFINE_STATIC_STRING(Aorta1ToRightBasilar);
// Bone
...
DEFINE_STATIC_STRING(Ground);
//-----------------------------NODES FOR ADVANCED CEREBRAL CIRCUIT-----------------------//
//LEFT COROTID
DEFINE_STATIC_STRING(LeftCorotid);
//LEFT ANTERIOR
DEFINE_STATIC_STRING(LeftAnteriorArteries1);
DEFINE_STATIC_STRING(LeftAnteriorArteries2);
DEFINE_STATIC_STRING(LeftAnteriorCapillaries);
DEFINE_STATIC_STRING(LeftAnteriorVeins1);
DEFINE_STATIC_STRING(LeftAnteriorVeins2);
DEFINE_STATIC_STRING(LeftAnteriorVeinsCheck);
//LEFT MEDIAL
DEFINE_STATIC_STRING(LeftMedialArteries1);
DEFINE_STATIC_STRING(LeftMedialArteries2);
DEFINE_STATIC_STRING(LeftMedialCapillaries);
DEFINE_STATIC_STRING(LeftMedialVeins1);
DEFINE_STATIC_STRING(LeftMedialVeins2);
DEFINE_STATIC_STRING(LeftMedialVeinsCheck);
//RIGHT COROTID
DEFINE_STATIC_STRING(RightCorotid);
//RIGHT ANTERIOR
DEFINE_STATIC_STRING(RightAnteriorArteries1);
DEFINE_STATIC_STRING(RightAnteriorArteries2);
DEFINE_STATIC_STRING(RightAnteriorCapillaries);
DEFINE_STATIC_STRING(RightAnteriorVeins1);
DEFINE_STATIC_STRING(RightAnteriorVeins2);
DEFINE_STATIC_STRING(RightAnteriorVeinsCheck);
//RIGHT MEDIAL
DEFINE_STATIC_STRING(RightMedialArteries1);
DEFINE_STATIC_STRING(RightMedialArteries2);
DEFINE_STATIC_STRING(RightMedialCapillaries);
DEFINE_STATIC_STRING(RightMedialVeins1);
DEFINE_STATIC_STRING(RightMedialVeins2);
DEFINE_STATIC_STRING(RightMedialVeinsCheck);
//LEFT BASILAR
DEFINE_STATIC_STRING(LeftBasilar);
//LEFT ANTERIOR
DEFINE_STATIC_STRING(LeftPosteriorArteries1);
DEFINE_STATIC_STRING(LeftPosteriorArteries2);
DEFINE_STATIC_STRING(LeftPosteriorCapillaries);
DEFINE_STATIC_STRING(LeftPosteriorVeins1);
DEFINE_STATIC_STRING(LeftPosteriorVeins2);
DEFINE_STATIC_STRING(LeftPosteriorVeinsCheck);
//RIGHT BASILAR
DEFINE_STATIC_STRING(RightBasilar);
//RIGHT ANTERIOR
DEFINE_STATIC_STRING(RightPosteriorArteries1);
DEFINE_STATIC_STRING(RightPosteriorArteries2);
DEFINE_STATIC_STRING(RightPosteriorCapillaries);
DEFINE_STATIC_STRING(RightPosteriorVeins1);
DEFINE_STATIC_STRING(RightPosteriorVeins2);
DEFINE_STATIC_STRING(RightPosteriorVeinsCheck);
};
...
//-----------------------------PATHS FOR ADVANCED CEREBRAL CIRCUIT-----------------------//
// LEFT COROTID
DEFINE_STATIC_STRING(LeftCorotidToGround);
// LEFT ANTERIOR
DEFINE_STATIC_STRING(LeftCorotidToLeftAnteriorArteries1);
DEFINE_STATIC_STRING(LeftAnteriorArteries1ToLeftAnteriorArteries2);
DEFINE_STATIC_STRING(LeftAnteriorArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftAnteriorArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(LeftAnteriorArteries2ToCapillaries);
DEFINE_STATIC_STRING(LeftAnteriorCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(LeftAnteriorCapillariesToLeftAnteriorVeins1);
DEFINE_STATIC_STRING(LeftAnteriorVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftAnteriorVeins1ToLeftAnteriorVeins2);
DEFINE_STATIC_STRING(LeftAnteriorVeinsCheckToLeftAnteriorVeins2);
DEFINE_STATIC_STRING(SpinalFluidToLeftAnteriorVeinsCheck);
DEFINE_STATIC_STRING(LeftAnteriorVeins2ToNeckVeins);
// LEFT MEDIAL
DEFINE_STATIC_STRING(LeftCorotidToLeftMedialArteries1);
DEFINE_STATIC_STRING(LeftMedialArteries1ToLeftMedialArteries2);
DEFINE_STATIC_STRING(LeftMedialArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftMedialArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(LeftMedialArteries2ToCapillaries);
DEFINE_STATIC_STRING(LeftMedialCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(LeftMedialCapillariesToLeftMedialVeins1);
DEFINE_STATIC_STRING(LeftMedialVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftMedialVeins1ToLeftMedialVeins2);
DEFINE_STATIC_STRING(LeftMedialVeinsCheckToLeftMedialVeins2);
DEFINE_STATIC_STRING(SpinalFluidToLeftMedialVeinsCheck);
DEFINE_STATIC_STRING(LeftMedialVeins2ToNeckVeins);
// RIGHT COROTID
DEFINE_STATIC_STRING(RightCorotidToGround);
// RIGHT ANTERIOR
DEFINE_STATIC_STRING(RightCorotidToRightAnteriorArteries1);
DEFINE_STATIC_STRING(RightAnteriorArteries1ToRightAnteriorArteries2);
DEFINE_STATIC_STRING(RightAnteriorArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(RightAnteriorArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(RightAnteriorArteries2ToCapillaries);
DEFINE_STATIC_STRING(RightAnteriorCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(RightAnteriorCapillariesToRightAnteriorVeins1);
DEFINE_STATIC_STRING(RightAnteriorVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(RightAnteriorVeins1ToRightAnteriorVeins2);
DEFINE_STATIC_STRING(RightAnteriorVeinsCheckToRightAnteriorVeins2);
DEFINE_STATIC_STRING(SpinalFluidToRightAnteriorVeinsCheck);
DEFINE_STATIC_STRING(RightAnteriorVeins2ToNeckVeins);
// RIGHT MEDIAL
DEFINE_STATIC_STRING(RightCorotidToRightMedialArteries1);
DEFINE_STATIC_STRING(RightMedialArteries1ToRightMedialArteries2);
DEFINE_STATIC_STRING(RightMedialArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(RightMedialArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(RightMedialArteries2ToCapillaries);
DEFINE_STATIC_STRING(RightMedialCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(RightMedialCapillariesToRightMedialVeins1);
DEFINE_STATIC_STRING(RightMedialVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(RightMedialVeins1ToRightMedialVeins2);
DEFINE_STATIC_STRING(RightMedialVeinsCheckToRightMedialVeins2);
DEFINE_STATIC_STRING(SpinalFluidToRightMedialVeinsCheck);
DEFINE_STATIC_STRING(RightMedialVeins2ToNeckVeins);
// LEFT BASILAR
DEFINE_STATIC_STRING(LeftBasilarToGround);
DEFINE_STATIC_STRING(LeftBasilarToLeftCorotid);
// LEFT POSTERIOR
DEFINE_STATIC_STRING(LeftBasilarToLeftPosteriorArteries1);
DEFINE_STATIC_STRING(LeftPosteriorArteries1ToLeftPosteriorArteries2);
DEFINE_STATIC_STRING(LeftPosteriorArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftPosteriorArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(LeftPosteriorArteries2ToCapillaries);
DEFINE_STATIC_STRING(LeftPosteriorCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(LeftPosteriorCapillariesToLeftPosteriorVeins1);
DEFINE_STATIC_STRING(LeftPosteriorVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(LeftPosteriorVeins1ToLeftPosteriorVeins2);
DEFINE_STATIC_STRING(LeftPosteriorVeinsCheckToLeftPosteriorVeins2);
DEFINE_STATIC_STRING(SpinalFluidToLeftPosteriorVeinsCheck);
DEFINE_STATIC_STRING(LeftPosteriorVeins2ToNeckVeins);
// RIGHT BASILAR
DEFINE_STATIC_STRING(RightBasilarToGround);
DEFINE_STATIC_STRING(RightBasilarToRightCorotid);
// RIGHT POSTERIOR
DEFINE_STATIC_STRING(RightBasilarToRightPosteriorArteries1);
DEFINE_STATIC_STRING(RightPosteriorArteries1ToRightPosteriorArteries2);
DEFINE_STATIC_STRING(RightPosteriorArteries1ToSpinalFluid);
DEFINE_STATIC_STRING(RightPosteriorArteries2ToSpinalFluid);
DEFINE_STATIC_STRING(RightPosteriorArteries2ToCapillaries);
DEFINE_STATIC_STRING(RightPosteriorCapillariesToSpinalFluid);
DEFINE_STATIC_STRING(RightPosteriorCapillariesToRightPosteriorVeins1);
DEFINE_STATIC_STRING(RightPosteriorVeins1ToSpinalFluid);
DEFINE_STATIC_STRING(RightPosteriorVeins1ToRightPosteriorVeins2);
DEFINE_STATIC_STRING(RightPosteriorVeinsCheckToRightPosteriorVeins2);
DEFINE_STATIC_STRING(SpinalFluidToRightPosteriorVeinsCheck);
DEFINE_STATIC_STRING(RightPosteriorVeins2ToNeckVeins);
